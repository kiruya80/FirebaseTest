...
public class DaumTopJsoupAsyncTask extends AsyncTask<Void, Void, Void> {
    private String URL = "https://www.daum.net/";
    private String SELECT = "span.txt_issue";
    ...
    public DaumTopJsoupAsyncTask(int number, TopCompleteListener listener) {
